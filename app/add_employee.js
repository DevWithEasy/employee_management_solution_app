...
export default function AddEmployee() {
    ...
    const data = field === 'section' ?
        ...
        :
        field === 'designation' ?
            designations.map(designation => ({ label: designation.name, value: designation.name }))
            :
    ...
    return (
        ...
        >
            ...
            >
                ...
                />
                <AppText
                    styles='w-1/2 pt-1 justify-center items-center text-center bg-gray-100 text-lg rounded'
                >
                    {id}
                </AppText>
            </View>
